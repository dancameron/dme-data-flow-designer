...
<template>
	<div>
		<IconColumn :defaultIcons="defaultIcons" :availableIcons="defaultIcons" :largeIcon="true" :limit="1"  :title="title" :pluralTitle="pluralTitle" storageId="mc" />
	</div>
</template>
...
export default {
	...
	data() {
		return {
			title: 'Manufacturer’s Servers',
			pluralTitle: 'Manufacturer’s Servers',
			defaultIcons: [
				{
